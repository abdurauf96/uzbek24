      ...
      <div class="basic-flex main-wrapper">
        ...
        <section class="article-block middle-section">
          ...
          <div class="most-viewed" >
            <h3 class="most-viewed__title">{{ $category->translate(\App::getLocale())->name }}</h3>
            ...
            {{ $posts->links() }}
            <a id="posts_btn" href="#posts_btn" class="more-load-link loadMoreBtn" data-page="2" data-link="?page=" data-div="#resultLatestPost">@lang('messages.more')</a>
          </div>
